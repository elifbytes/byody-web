        ...
        <footer className="bg-primary px-6 pt-10 pb-6 text-[#d6dc9b]">
            <div className="mx-auto flex max-w-7xl flex-col items-center space-y-20 text-center">
                ...
                <div className="flex justify-center space-x-5">
                    <a href="https://shopee.co.id" target="_blank" rel="noopener noreferrer" className="h-10 w-10 fill-background">
                    ...
                    <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="h-10 w-10 fill-background">
                        <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <title>TikTok</title>
                    ...
                    <a href="https://wa.me/628123456789" target="_blank" rel="noopener noreferrer">
                        <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 fill-background">
